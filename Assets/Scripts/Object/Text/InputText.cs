...
public class InputText : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.anyKeyDown)
        {
            if (text.text == "パスワードが正しくありません")
            {
                text.text = "パスワードを入力してください"; //再度入力を促す初期文を出力する
            }
    ...
    {
        //もし出力している文が初期文ならば入力された数字をそのまま出力、そうでないなら文字列を結合して出力
    ...
    private void DeleteNumber()
    {
        ...
        {
            string newString; //出力している文字列から末尾の文字を消した文字列を格納
